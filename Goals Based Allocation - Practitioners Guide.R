...
goal_data_raw = read.csv(
  "<ENTER FILE LOCATION HERE>/Example Goal Details.csv")
capital_market_expectations_raw = read.csv(
  "<ENTER FILE LOCATION HERE>/Capital Market Expectations.csv")
correlations_raw = read.csv(
  "<ENTER FILE LOCATION HERE>/Correlations - Kitchen Sink.csv")
